...
Learn from Absinthe apps written by experienced developers.

You'll find the source code for the Real World Absinthe apps in the [`apps/`](apps/) subdirectory.

Thank you to every developer who has worked on a project this repo links to, your work is helping developers learn Absinthe.

## How to install on your computer

```bash
# Clone this git repo:
git clone git@github.com:szTheory/real-world-absinthe.git

cd real-world-absinthe/
